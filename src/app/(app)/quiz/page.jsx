...
export default function Quiz() {
    ...
    const reviewCompleteQuestion = () => {
        setShowIncompleteOnly(false);
        setShowFlaggedOnly(false);
        setShowCompleteOnly(true);
    };
          ...
          <span className="p-0 mr-5" style={{ marginRight: '20px' }}>
            ...
            >
                ...
                <Modal.Footer className="modal-footer-review">
                    <button className="pre-btn mx-2" onClick={reviewAllQuestions}>
                        Review All
                    </button>
                    ...
                    <button className="pre-btn mx-2" onClick={reviewCompleteQuestion}>
                        Review Complete
                    </button>

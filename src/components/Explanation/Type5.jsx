...
export default function Type1({ questionlists }) {
  ...
  return (
    <div className="questions-page">
      <Row>
        <Col md={12}>
          <div className="ques-text pt-4">
            {questionlist?.question_name && parse(questionlist?.question_name)}

            {questionlist?.question_img && (
              <img
                src={handleimageUrl(questionlist?.question_img)}
                alt="question_img"
                className="mb-1 mt-4 p-3 "
              />
            )}
          </div>
          ...
          <div className="ques-text p-2 mt-5">
            <h5>
